...
class NodeUI extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: AnimatedOpacity(
        ...
        child: _buildNodeWrapper(
          ...
          cardColor: cardColor,
          child: _buildBodyContent(textColor, iconColor, isSelected),
        ),
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(node.text, style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: 16)),
        ),
        Table(
  ...
  Widget _buildTrianglePyramid(Color textColor, bool isSelected) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        const SizedBox(height: 40), // Top of triangle
  ...
  Widget _buildTimeline(Color textColor, bool isSelected) {
    ...
    return Column(
      ...
      mainAxisSize: MainAxisSize.min,
      children: [
        Text(node.text, style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: 16)),
        const SizedBox(height: 12),
