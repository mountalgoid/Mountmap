...
class _AttachmentViewerScreenState extends State<AttachmentViewerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _buildBody(ext),
      bottomNavigationBar: isTxt ? _buildMiniToolbar() : (isLink ? _buildWebToolbar() : null),
    );
  }
  ...
  Widget _buildBody(String ext) {
    ...
    return const Center(child: Text("Format tidak didukung untuk pratinjau in-app", style: TextStyle(color: Colors.white)));
  }
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  _toolbarBtn(Icons.undo_rounded, "Undo", () => _undoController.undo()),
                  _toolbarBtn(Icons.redo_rounded, "Redo", () => _undoController.redo()),
                  _toolbarBtn(Icons.content_paste_rounded, "Tempel", _pasteText),
                  _toolbarBtn(Icons.select_all_rounded, "Semua", () => _textController.selection = TextSelection(baseOffset: 0, extentOffset: _textController.text.length)),
                  _toolbarBtn(Icons.search_rounded, "Cari", _showSearchReplace),
                  _toolbarBtn(Icons.chevron_left_rounded, "Kiri", () => _moveCursor(-1)),
                  _toolbarBtn(Icons.chevron_right_rounded, "Kanan", () => _moveCursor(1)),
                  _toolbarBtn(Icons.save_rounded, "Simpan", _saveTextFile),
                  _toolbarBtn(Icons.close_rounded, "Tutup", () => Navigator.pop(context)),
                ],
              ),
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text("Cari dan Ganti", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              TextField(
                ...
                decoration: _dialogInputDecor("Cari teks...").copyWith(
              ...
              TextField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: _dialogInputDecor("Ganti dengan..."),
              ),
              const SizedBox(height: 16),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
  ...
  InputDecoration _dialogInputDecor(String hint) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(widget.item.name, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(_formatDuration(_audioPosition), style: const TextStyle(color: Colors.white54, fontSize: 12)),
                  Text(_formatDuration(_audioDuration), style: const TextStyle(color: Colors.white54, fontSize: 12)),
                ],
              ),
            ),
            const SizedBox(height: 20),
